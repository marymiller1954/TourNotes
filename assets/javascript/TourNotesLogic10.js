...
startDateR = startDate.substring(0, 4);
...
startDateRange = eventDate1 + startDateR;
...
sescondDateRange = "2016" + secondDate + "00";
...
//thirdDate = "2016" + thirdDate;
thirdDateRange = "2016" + thirdDate + "00";
...
//fourthDate = "2016" + fourthDate;
fourthDateRange = "2016" + fourthDate + "00";
...
//fifthDate = "2016" + fifthDate;
fifthDateRange = "2016" + fifthDate + "00";
...
//	     $("#query").on("click", function(){
		...
		var daterange2 = secondDate + "-" + sescondDateRange;
		...
		for (var i = 0; i < 5; i++) { 
			...
			if (i==0) {
				dest = destination1;
				date = daterange1;
				var queryURL = queryURLbase + destination1 + daterange1;
			}
			else if (i==1)  {
				dest = destination2;
				date = daterange2;
				var queryURL = queryURLbase + destination2 + daterange2;
			}
			else if (i==2)  {
				dest = destination3;
				date = daterange3;
				var queryURL = queryURLbase + destination3 +daterange3;
			}
			else if (i==3)  {
				dest = destination4;
				date = daterange4;
				var queryURL = queryURLbase + destination4 + daterange4;
			}
			else if (i==4)  {
				dest = destination5;
				date = daterange5;
				var queryURL = queryURLbase + destination5 + daterange5;
			};
