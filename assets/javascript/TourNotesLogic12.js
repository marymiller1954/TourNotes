...
var stop2eventArray1 = [];
var stop2eventArray2 = [];
var stop2eventArray3 = [];
var stop2eventArray4 = [];
var stop2eventArray5 = [];

var stop3eventArray1 = [];
var stop3eventArray2 = [];
var stop3eventArray3 = [];
var stop3eventArray4 = [];
var stop3eventArray5 = [];

var stop4eventArray1 = [];
var stop4eventArray2 = [];
var stop4eventArray3 = [];
var stop4eventArray4 = [];
var stop4eventArray5 = [];

var stop5eventArray1 = [];
var stop5eventArray2 = [];
var stop5eventArray3 = [];
var stop5eventArray4 = [];
var stop5eventArray5 = [];
			...
			for (var b = 0; b < 5; b++) { 
				if (a == 0)
				 console.log("entering the b loop");
					  if (b == 0) {stop1eventArray1 = [destination1, eventName1, venueName1, eventDate1, eventTime1]
					  }
	                  else if (b == 1) {stop1eventArray2 = [destination2, eventName2, venueName2, eventDate2, eventTime2] 
	                  }
				      else if (b == 2) {stop1eventArray3 = [destination3, eventName3, venueName3, eventDate3, eventTime3]
				      }
				      else if (b == 3) {stop1eventArray4 = [destination4, eventName4, venueName4, eventDate4, eventTime4]
				      }
				      else if (b == 2) {stop1eventArray5 = [destination5, eventName5, venueName5, eventDate5, eventTime5]
				      }                  
                  }

                  if (a == 1) {

	                  if (b == 0) {stop2eventArray1 = [destination1, eventName1, venueName1, eventDate1, eventTime1]
					  }
	                  else if (b == 1) {stop2eventArray2 = [destination2, eventName2, venueName2, eventDate2, eventTime2] 
	                  }
				      else if (b == 2) {stop2eventArray3 = [destination3, eventName3, venueName3, eventDate3, eventTime3]
				      }
				      else if (b == 3) {stop2eventArray4 = [destination4, eventName4, venueName4, eventDate4, eventTime4]
				      }
				      else if (b == 2) {stop2eventArray5 = [destination5, eventName5, venueName5, eventDate5, eventTime5]
				      }
                  }
                  
                  if (a == 2) {

	                  if (b == 0) {stop3eventArray1 = [destination1, eventName1, venueName1, eventDate1, eventTime1]
					  }
	                  else if (b == 1) {stop3eventArray2 = [destination2, eventName2, venueName2, eventDate2, eventTime2] 
	                  }
				      else if (b == 2) {stop3eventArray3 = [destination3, eventName3, venueName3, eventDate3, eventTime3]
				      }
				      else if (b == 3) {stop3eventArray4 = [destination4, eventName4, venueName4, eventDate4, eventTime4]
				      }
				      else if (b == 2) {stop3eventArray5 = [destination5, eventName5, venueName5, eventDate5, eventTime5]
				      }
                  }

                  if (a == 3) {

	                  if (b == 0) {stop4eventArray1 = [destination1, eventName1, venueName1, eventDate1, eventTime1]
					  }
	                  else if (b == 1) {stop4eventArray2 = [destination2, eventName2, venueName2, eventDate2, eventTime2] 
	                  }
				      else if (b == 2) {stop4eventArray3 = [destination3, eventName3, venueName3, eventDate3, eventTime3]
				      }
				      else if (b == 3) {stop4eventArray4 = [destination4, eventName4, venueName4, eventDate4, eventTime4]
				      }
				      else if (b == 2) {stop4eventArray5 = [destination5, eventName5, venueName5, eventDate5, eventTime5]
			         }
                  }

                  if (a == 4) {

	                  if (b == 0) {stop5eventArray1 = [destination1, eventName1, venueName1, eventDate1, eventTime1]
					  }
	                  else if (b == 1) {stop5eventArray2 = [destination2, eventName2, venueName2, eventDate2, eventTime2] 
	                  }
				      else if (b == 2) {stop5eventArray3 = [destination3, eventName3, venueName3, eventDate3, eventTime3]
				      }
				      else if (b == 3) {stop5eventArray4 = [destination4, eventName4, venueName4, eventDate4, eventTime4]
				      }
				      else if (b == 2) {stop5eventArray5 = [destination5, eventName5, venueName5, eventDate5, eventTime5]
			         }                 
...
console.log("stop 1 event array1: ",stop1eventArray1);	
console.log("stop 2 event array1: ",stop2eventArray1);	
console.log("stop 3 event array1: ",stop3eventArray1);	
console.log("stop 4 event array1: ",stop4eventArray1);	
console.log("stop 5 event array1: ",stop5eventArray1);	
...
sessionStorage.setItem('stop1eventArray1',stop1eventArray1);
sessionStorage.setItem('stop2eventArray1',stop2eventArray1);
sessionStorage.setItem('stop3eventArray1',stop3eventArray1);
sessionStorage.setItem('stop4eventArray1',stop4eventArray1);
sessionStorage.setItem('stop5eventArray1',stop5eventArray1);  
